  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl font-bold">Government Education Platform</CardTitle>
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Badge className={`w-fit ${roleColors[role]}`}>
              {roleIcons[role]}
        ...
        <div className="mt-6 text-center text-sm text-muted-foreground">
          ...
          <div className="mt-2 space-y-1">
            <p>
              <strong>Student:</strong> student@edu.gov.in
            </p>
            <p>
              <strong>Teacher:</strong> teacher@edu.gov.in
            </p>
            <p>
              <strong>Admin:</strong> admin@edu.gov.in
            </p>
            <p>
